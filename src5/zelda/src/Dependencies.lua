...
gTextures = {
    ...
    ['pot-idle'] = love.graphics.newImage('graphics/character_pot_walk.png'),
...
gFrames = {
    ...
    ['pot-idle'] = GenerateQuads(gTextures['pot-idle'], 16, 32),
...
gSounds = {
    ...
    ['pickup_heart'] = love.audio.newSource('sounds/pickup_heart.wav', 'static')
}
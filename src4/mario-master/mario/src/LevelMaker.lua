...
function LevelMaker.generate(width, height)
    ...
    for x = 1, width do
        ...
        if math.random(7) == 1 and x ~= width - 2  then
            ...
            elseif math.random(10) == 3 and not lockSpawned and x ~= width - 2 then
                lockSpawned = true
                table.insert(objects,
                    GameObject {
                        texture = 'locks',
                        ...
                        onCollide = function(obj)
                            if canUnlock and not obj.hit then
                                ...
                                local flag1 = GameObject {
                                    ...
                                    table.insert(objects, flag1)
                            end
                        end
                    }   
                )

            elseif math.random(10) == 1 and not keySpawned and x ~= width - 2 then
                keySpawned = true
                table.insert(objects,
                GameObject {
                    texture = 'locks',

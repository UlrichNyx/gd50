...
function GenerateKeys(atlas)
    local x = 0
    local y = 0
    local quads = {}

    for i = 0, 3 do
        table.insert(quads, love.graphics.newQuad(x*i, y, 16, 9, atlas))
    end
    return quads
end

function GenerateLocks(atlas)
    local x = 0
    local y = 16
    local quads = {}
    for i = 0, 3 do
        table.insert(quads, love.graphics.newQuad(x*i, y, 16, 16, atlas))
    end
    return quads
end
